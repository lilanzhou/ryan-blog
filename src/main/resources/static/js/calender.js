    ...
    var calendar = function(calendarId){
        ...
        c.init = function(){
            ...
            if(loadStyles.mark != 'load'){
                loadStyles(".calendarDiv {width:200px;text-align:center;}\
            .Table{width:200px;height:200px;}\
            .box{margin-left:15px;margin-right:15px;text-align:center;width:240px;height:22px;font-weight:bold;font-size:18px;}\
            ...
            .blueTr{color:darkcyan;text-align:center;};");
            }
